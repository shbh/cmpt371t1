 ...
 * information, color information, the vertex indices and drawing functionality,
...
public class Box implements IGameObject
{
     ...
     * 
     * It defines the eight vertices a cube has based on the OpenGL coordinate
     * system
     */
    private float vertices[] = { -1.0f, -1.0f, -1.0f, // lower back left (0)
     ...
     * 
     * The indices define our triangles. Always two define one of the six faces
     * a cube has.
     */
    private byte indices[] = {
    /*
     * Example: Face made of the vertices lower back left (lbl), lfl, lfr, lbl,
     * lfr, lbr
     */
    0, 4, 5, 0, 5, 1,
	    // and so on...
    1, 5, 6, 1, 6, 2, 2, 6, 7, 2, 7, 3, 3, 7, 4, 3, 4, 0, 4, 7, 6, 4, 6, 5, 3, 0, 1, 3, 1, 2 };
