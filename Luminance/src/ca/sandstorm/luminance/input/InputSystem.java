 ...
 * 
 * Modifications (shinhalsafar@gmail.com)
 * - Removed system registry everywhere for this games similar object
 */
...
public class InputSystem
{
    ...
    {
	TimeSystem time = Engine.getInstance().getTimer();
	...
	mTouchScreen.press(index, time.getGameTime(), x, Engine.getInstance()
		.getViewHeight() - y);
    }
